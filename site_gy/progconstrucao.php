...
<head>
    ...
    <title>Dashboard | Construção</title>
					        ...
					        <div class="col-lg-12">
					            <div id="" class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form id="form-highlight-cured" action="progconstrucao.php">
                                             <div class="col-md-2">
                                             ...
                                             <div class="col-md-2">
                                                <label>Divisão</label>
                                                <select id="edt-turno" name="divisao" class="form-control">
                                ...
                                <table id="demo-dt-selection" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Maquina</th>
                                            <th>Sequencia</th>
                                            <th class="min-tablet">Pneu</th>
                                            <th class="min-desktop">Programado</th>
                                        </tr>
                                    </thead>
                                    <?php
                                        $sql = "SELECT 
                                        DISTINCT MAQUINA MAQ,
                                        TURNO,
                                        SEQ,
                                        PNEU,
                                        PROGRAMADO,
                                    ...
                                    FROM 
                                        DASHBOARD_PPP 
                                    WHERE 
                                        DATA_PROD = TO_DATE('$data_init', 'DD/MM/YY')
                                        AND AREA = '$divisao' AND TURNO LIKE '$turno%' 
                                    ORDER BY
                                        MAQUINA,
                                        TURNO,
                                        SEQ";
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li class="active-link"><a href="progconstrucao.php?datainit=<?php echo date('d-m-Y'); ?>&divisao=B1&turno=">Construção</a></li>
