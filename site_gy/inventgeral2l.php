            ...
            <div id="content-container">
                ...
                <div id="page-content">
					        ...
					        <div class="col-lg-12">
					            <div id="" class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form  id="form-highlight-cured" action="inventgeral.php">
                                            <div class="col-md-2">
                                                 <label>Data</label>
                                                <div id="dt-inicio">
                        ...
                        <div class="panel">
                            ...
                            ?>
                                <table id="table-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th class=""></th>
                                            <th class="">Data</th>
                                    ...
                                    <?php
                                        ...
                                        while(OCIFetchInto($stmt_temp, $linha, OCI_ASSOC)){
                                            ...
                                            <tr><?php
                                                ...
                                                <td><?php echo $data; ?></td>
                                                <td><?php 
                                                    if ($linha['MATERIAL'] == "RODAGEM B1" || $linha['MATERIAL'] == "RODAGEM B2") {
                                                        echo "TR";
...
?>
                                            ...
                                            $sql1 = "SELECT  SUM(I.qtd) PNEU_CRU FROM
                                            TB_INV_PNEU I 
